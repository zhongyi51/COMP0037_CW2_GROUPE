...
class AStarByMDPlanner(GreedyRewiringPlanner): # or think about inherite from dijkstra if you feel like that is more natural
    ...
    def _costEvalFunc(self, fromCell, toCell):
        ...
        g = self.computeLStageAdditiveCost(fromCell, connerCell) + self.computeLStageAdditiveCost(connerCell, toCell)
